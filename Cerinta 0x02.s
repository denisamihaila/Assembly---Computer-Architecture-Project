.data
	...
	lineIndex: .space 4
	columnIndex: .space 4
	inpointer: .space 4     #pointer la in.txt
	outpointer: .space 4   #pointer la out.txt
	...
	w: .asciz "w"    #write
	r: .asciz "r"    #read
	in: .asciz "in.txt"   #denumire fisier de intrare
	out: .asciz "out.txt"   #denumire fisier de iesire
.text
...
construct:   
	...
	movl 20(%ebp), %edx    #in edx am inpointer
	...
	while:       #while(index<p)
		...
		incl -12(%ebp)      #i-am incrementat pe i si j
		incl -16(%ebp)
